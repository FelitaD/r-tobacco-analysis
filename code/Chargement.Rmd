...
data_2011_2019 <- Reduce(function(x, y) merge(x, y, all=TRUE), list(data_2011, data_2013, data_2013, data_2014, data_2015, data_2016, data_2017, data_2018, data_2019))

data_1985_2019 <- Reduce(function(x, y) merge(x, y, all=TRUE), list(data_1985_1990, data_1991_2000, data_2001_2010, data_2011_2019))
```

```{r}
write.csv(data_1985_1990, paste("~/CNAM/Stats/Mini-memoire/data/", 'data_1985_1990.csv',sep = ''))
write.csv(data_1991_2000, paste("~/CNAM/Stats/Mini-memoire/data/", 'data_1991_2000.csv',sep = ''))
write.csv(data_2001_2010, paste("~/CNAM/Stats/Mini-memoire/data/", 'data_2001_2010.csv',sep = ''))
write.csv(data_2011_2019, paste("~/CNAM/Stats/Mini-memoire/data/", 'data_2011_2019.csv',sep = ''))
write.csv(data_1985_2019, paste("~/CNAM/Stats/Mini-memoire/data/", 'data_1985_2019.csv',sep = ''))
```