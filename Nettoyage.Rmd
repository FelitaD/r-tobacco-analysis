...
```{r}
brfss_2013 <- read.xport("data/LLCP2013.XPT")
...
```{r}
write.csv(data_2013_2019, paste("~/CNAM/Stats/Mini-memoire/data/", 'data_2013_2019',sep = ''))
```

```{r}
data_2013_2019 <- read.csv("~/CNAM/Stats/Mini-memoire/data/data_2013_2019")
```
