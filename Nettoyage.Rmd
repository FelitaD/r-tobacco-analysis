...
```{r}
data <- subset(data_2013_2019, select = c("SMOKE100","SMOKDAY2","STOPSMK2",
                                                    "LASTSMK2","USENOW3","X_SMOKER3", "X_RFSMOK3",
                                                    "X_STATE", "IYEAR", 
                                                    "NUMADULT", "VETERAN3","X_EDUCAG", "X_INCOMG",
...
data$X_SMOKER3 <- as.factor(data$X_SMOKER3)
levels(data$X_SMOKER3) <- c("Fumeur quotidien", "Fumeur occasionnel", "Ancien fumeur", "Non fumeur")
...
data$ADDEPEV2[data$ADDEPEV2  == 2] <- 
data$ADDEPEV2_FACTOR = cut(data$ADDEPEV2, 2, labels=c("Non", 'Oui'))
